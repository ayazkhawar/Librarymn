...
class ret(Tk):
    def __init__(self):
        ...
        Label(self, text='RETURN BOOK', fg='sea green',bg='pale green',font=('times new roman', 20, 'bold')).place(x=125, y=30)
        Label(self, text='ENTER BOOK ID', fg='sea green', bg='pale green', font=('Comic Scan Ms', 15, 'bold')).place(x=100, y=100)
        Entry(self, textvariable=a, width=40).place(x=100, y=140)
        Button(self, text="Return",fg='white',bg='sea green', width=25, command=qui).place(x=140, y=180)
ret().mainloop()