...
class Search(Tk):
    def __init__(self):
        ...
        l1=Label(self,text="SEARCH STUDENTS",fg='sea green', bg='pale green', font=("Times new roman",20,'bold')).place(x=290,y=40)
        ...
        self.b= Button(self,text="Find",width=15,fg='white', bg='sea green',font=("Courier-new",8,'bold'),command= ge )
        ...
        self.la = Label(self, text="ENTER",fg='sea green', bg = 'pale green', font=("Courier new", 15, 'bold')).place(x=180, y=140)
